    ...
    { 
        ...
        <div>            
            <Holder>
              ...
              <Epoc>
                <div>
                  <div>Epoc {(this.props.data[step].current_epoch_id > 0) ? this.props.data[step].current_epoch_id - 1 : "?"}</div>
                </div>
                <Row>
                  <div>VDF:</div>
              ...
              <Epoc>
                <div>
                  <div>Epoc {(this.props.data[step].current_epoch_id > 1) ? this.props.data[step].current_epoch_id - 2 : "?"}</div>
                </div>
                <Row>
                  <div>VDF:</div>
              ...
              <Epoc>
                <div>
                  <div>Epoc {(this.props.data[step].current_epoch_id > 2) ? this.props.data[step].current_epoch_id - 3 : "?"}</div>
                </div>
                <Row>
                  <div>VDF:</div>
